...
interface Language {
    ...
    val name: String
    val parent: Language?
    val matchers: Map<dev.azn9.plugins.discord.icons.matcher.Matcher.Target, dev.azn9.plugins.discord.icons.matcher.Matcher>
    val match: LanguageMatch
    val assetIds: Iterable<String>

    fun findMatch(target: dev.azn9.plugins.discord.icons.matcher.Matcher.Target, fields: Collection<String>): LanguageMatch? {
