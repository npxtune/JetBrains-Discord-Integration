...
object LocalLanguage {
    class Simple(source: LocalSource, id: String, name: String, parent: Language?, assetIds: List<String>?, matchers: Map<dev.azn9.plugins.discord.icons.matcher.Matcher.Target, dev.azn9.plugins.discord.icons.matcher.Matcher>) :
