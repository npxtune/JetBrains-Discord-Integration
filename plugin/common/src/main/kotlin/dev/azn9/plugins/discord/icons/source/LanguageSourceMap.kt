...
import dev.azn9.plugins.discord.icons.utils.setWith
...
interface LanguageSourceMap : Map<String, LanguageSource> {
    ...
    fun createSimpleLanguage(fileId: String, name: String, parent: Language?, assetIds: List<String>?, matchers: Map<dev.azn9.plugins.discord.icons.matcher.Matcher.Target, dev.azn9.plugins.discord.icons.matcher.Matcher>): Language.Simple
    ...
    private fun createSimpleLanguage(
        ...
        val matchers: Map<dev.azn9.plugins.discord.icons.matcher.Matcher.Target, dev.azn9.plugins.discord.icons.matcher.Matcher> = source["match"]?.let { match ->
            EnumMap<dev.azn9.plugins.discord.icons.matcher.Matcher.Target, dev.azn9.plugins.discord.icons.matcher.Matcher>(
                dev.azn9.plugins.discord.icons.matcher.Matcher.Target::class.java).apply {
                for (target in dev.azn9.plugins.discord.icons.matcher.Matcher.Target.values()) {
    ...
    private fun JsonNode.asMatchers(): Set<dev.azn9.plugins.discord.icons.matcher.Matcher> = when {
        isNull -> emptySet()
    ...
    private fun JsonNode.asMatcher(): dev.azn9.plugins.discord.icons.matcher.Matcher {
    ...
    private fun JsonNode.asStartsWithMatcher() = dev.azn9.plugins.discord.icons.matcher.Matcher.Text.StartsWith(asStrings())

    private fun JsonNode.asEndsWithMatcher() = dev.azn9.plugins.discord.icons.matcher.Matcher.Text.EndsWith(asStrings())

    private fun JsonNode.asContainsMatcher() = dev.azn9.plugins.discord.icons.matcher.Matcher.Text.Contains(asStrings())

    private fun JsonNode.asEqualsMatcher() = dev.azn9.plugins.discord.icons.matcher.Matcher.Text.Equals(asStrings())

    private fun JsonNode.asRegExMatcher() = dev.azn9.plugins.discord.icons.matcher.Matcher.Text.RegEx(asStrings())
    ...
    private fun JsonNode.asAny() = dev.azn9.plugins.discord.icons.matcher.Matcher.Combining.Any(asMatchers())

    private fun JsonNode.asAll() = dev.azn9.plugins.discord.icons.matcher.Matcher.Combining.All(asMatchers())
}
