...
plugins {
    alias(libs.plugins.kotlin.pre223)
    alias(libs.plugins.intellij.pre223)
...
intellij {
    ...
    version(libs.versions.ide.pre223)
    downloadSources(!isCI)
    sandboxDir("${project.rootDir.absolutePath}/.sandbox.pre223")
...
tasks {
    ...
    buildPlugin {
        archiveBaseName(rootProject.name + "-pre223")
    }
